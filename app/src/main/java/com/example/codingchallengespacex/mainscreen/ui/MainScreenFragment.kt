        ...
        mBinding = FragmentMainScreenBinding.inflate(inflater, container, false).apply {
            composeView.apply {
                ...
                */
                ...
                setContent {
                    MdcTheme {
                        MainScreen(listLaunchesViewModel, this@MainScreenFragment::onClick, this@MainScreenFragment::showError)
                    }
                }
            }
        }
...
//    }
    ...
    private fun showError(message: String){
        Toast.makeText(this@MainScreenFragment.context, message, Toast.LENGTH_SHORT ).show()
    }
